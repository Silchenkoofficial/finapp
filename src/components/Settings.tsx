      ...
      {editing ? (
        <div className="flex items-center gap-2 shrink-0">
          <Input
            ...
            autoFocus
          />
          <Button size="sm" onClick={save} className="h-9 px-3">
            OK
          </Button>
        </div>
      ) : (
    ...
    <div className="flex items-start px-4 py-3 border-b border-stone-100 last:border-0 gap-3">
      ...
      {editing ? (
        <div className="flex flex-col gap-1.5 items-end shrink-0">
          ...
          <Button size="sm" onClick={save} className="h-8 px-3 text-xs">
            OK
          </Button>
        </div>
      ) : (
          ...
          <Card className="rounded-2xl border-red-200 bg-red-50">
            <CardContent className="p-4 text-center">
              <div className="text-sm font-medium text-red-800 mb-3">
                Точно сбросить? Все изменения удалятся.
              </div>
